...
$(this).animate({width: "60%", height: "8em"
},500);
});
    $('.detail_textarea').bind('blur',function () {
if ($(this).val() == ''){
            $(this).animate({width: "27%", height: "5em"
},500);
}
    });
...
var getSelect = $(this).children('option:selected').attr("id");
        switch (getSelect) {
            case "type_1": curFirst = 0;
break;
            case "type_2": curFirst = 1;
break;
            case "type_3": curFirst = 2;
break;
            case "type_4": curFirst = 3;
break;
            case "type_5": curFirst = 4;
break;
            case "type_6": curFirst = 5;
break;
}
